 ...
 * )
 *
 * This is copied from migrate_plus module:
 *
 * @see https://git.drupalcode.org/project/migrate_plus/-/blob/8.x-5.x/src/Plugin/migrate/process/SkipOnValue.php
 *
...
class SkipOnValue extends ProcessPluginBase {
   ...
   */
  protected function compareValue($value, $skipValue, $equal = TRUE) : bool {
    if ($equal) {
